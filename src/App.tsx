        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-black rounded-t-lg border-4 border-slate-800 p-12 min-h-[500px] flex flex-col">
            ...
            <div className="flex-1 bg-slate-800 rounded p-8 border-2 border-amber-400/30 overflow-auto">
              <h3 className="text-xl font-bold text-amber-400 mb-6 font-mono">{currentSlide.heading}</h3>
              <div className="text-slate-200 text-lg leading-relaxed space-y-4 font-mono">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-black rounded-t-lg border-4 border-slate-800 p-12 min-h-[500px] flex flex-col">
            ...
            <div className="flex-1 bg-slate-800 rounded p-8 border-2 border-orange-400/30">
              <h3 className="text-xl font-bold text-orange-400 font-mono mb-4" dangerouslySetInnerHTML={{
              ...
              <div className="text-slate-200 text-xl leading-relaxed whitespace-pre-line font-mono" dangerouslySetInnerHTML={{

  ...
  reflection: {
    ...
    slides: [
      ...
      },
      {
        ...
        text: "What should we be thinking about? What guardrails or principles matter?"
      },
      {
        heading: "Moving Forward",
        text: "What opportunities and risks do you see? Add as many slides as you need to fully express your thoughts."
      }
    ]
  }
};
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-black rounded-t-lg border-4 border-slate-800 p-12 min-h-[500px] flex flex-col">
            ...
            <div className="flex-1 bg-slate-800 rounded p-8 border-2 border-amber-400/30 overflow-auto">
              ...
              <div className="text-slate-200 text-base leading-relaxed space-y-4" style={{fontFamily: 'Courier New, monospace'}}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-b from-slate-900 to-black rounded-t-lg border-4 border-slate-800 p-12 min-h-[500px] flex flex-col">
            ...
            <div className="flex-1 bg-slate-800 rounded p-8 border-2 border-orange-400/30">
              ...
              <div className="text-slate-200 text-lg leading-relaxed whitespace-pre-line" dangerouslySetInnerHTML={{
